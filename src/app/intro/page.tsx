...
function IntroInner() {
  ...
  return (
    <div className="relative flex min-h-dvh flex-1 flex-col items-center justify-start bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 px-4 pb-6 pt-[max(0.75rem,env(safe-area-inset-top))] sm:justify-center sm:py-6">
      ...
      <div className="relative z-20 w-full max-w-lg shrink-0 self-stretch pb-3 sm:pb-4">
        <RekenRaketBrandLink />
      </div>
