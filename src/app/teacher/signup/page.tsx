        ...
        <div className="w-full rounded-3xl border-2 border-indigo-100 bg-white p-6 shadow-xl">
          ...
          {awaitingEmail ? (
            <div className="mt-4 space-y-4">
              <p className="text-sm leading-relaxed text-slate-800">{t("signupCheckEmailBody", { email })}</p>
              <button
                type="button"
                disabled={resendBusy}
                onClick={() => void onResend()}
                className="w-full rounded-2xl border-2 border-violet-200 bg-violet-50 py-3 font-bold text-violet-900 hover:bg-violet-100 disabled:opacity-50"
              >
